...
export default {
  ...
  methods: {
    addNew () {
      this.hidden = true
      HTTP.post(`company/` + this.cid + `/year/` + this.yid + `/month/` + this.mid + `/addDebitDetails/` + this.bid, {
    ...
    getTotalQuantity (id) {
      let url = `company/` + this.cid + `/year/` + this.yid + `/month/` + this.mid + `/quantityTotal/` + id
      HTTP.get(url)
        .then(response => {
    ...
    getTotalAmount (id) {
      let url = `company/` + this.cid + `/year/` + this.yid + `/month/` + this.mid + `/amountTotal/` + id
      HTTP.get(url)
        .then(response => {
    ...
    getEntireDebitDetails () {
      let url = `company/` + this.cid + `/year/` + this.yid + `/month/` + this.mid + `/getDebitDetails/` + this.bid
      HTTP.get(url)
        .then(response => {
